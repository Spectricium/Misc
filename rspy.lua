...
local Simple = Create("TextButton",{Parent = TopBar,BackgroundColor3 = Color3.new(1, 1, 1),AutoButtonColor = false,BackgroundTransparency = 1,Position = UDim2.new(0, 5, 0, 0),Size = UDim2.new(0, 57, 0, 18),Font = Enum.Font.SourceSansBold,Text =  "Simple Spy "..edition.." Edition",TextColor3 = Color3.new(1, 1, 1),TextSize = 14,TextXAlignment = Enum.TextXAlignment.Left})
...
function genScript(remote, args)
    ...
    prevTables = {}
    return "--Generated By Simple Spy "..edition.." Edition\n"..gen
end
...
function()
    ...
    if func then
        ...
        codebox:setRaw("-- Generated by the SimpleSpy V3 "..edition.." edition serializer\n\n"..selected.Function)
        TextLabel.Text = "Done! Function info generated by the SimpleSpy V3 "..edition.." edition Serializer."
    else
